...
enum COMMAND
{
    ...
    MAKE_PROPOSAL=109,
    QPOOL_SWAP=110,
    QPOOL_BIGNUMBER_TO_STRING=300,
    QPOOL_BIGNUMBER_GET_STATUS=301,
    QPOOL_BIGSTRING_TO_NUMBER=302,
    QPOOL_BIGPLUS=303,
    QPOOL_BIGMINUS=304,
    QPOOL_BIGMULTIPLE=305,
    QPOOL_BIGDIV=306,
    QPOOL_BIGOREQUALCOMPARISON=307,
    QPOOL_SMALLOREQUALCOMPARISON=308,
    QPOOL_BIGCOMPARISON=309,
    QPOOL_SMALLCOMPARISON=310,
    QPOOL_BIGDMODULUS=311,
    QPOOL_DEPOSIT_EXPENSIVE_TOKEN=312,
    QPOOL_WITHDRAW_EXPENSIVE_TOKEN=313,
    QPOOL_GET_AMOUNT_OF_EXPENSIVE_TOKEN_USER_DEPOSITED=314
};
